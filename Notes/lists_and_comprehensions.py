...
my_list.reverse()  # reverses the current order
print(my_list)
...
# list comprehensions (show the old way then the new way)
# [returned_item for iterator list/range filter]

# make a list from 0 - 100
my_list = []
for i in range(101):
    my_list.append(i ** 2)
print(my_list)
...
# make a list of 0 - 100 squared, but filter out the odd number
my_list = []
for i in range(101):
    if i ** 2 % 2 == 0:
        my_list.append(i ** 2)
